package com.example.calzado.view.config.profile
...
import com.example.calzado.view.FormActivity
...
class ProfileActivity :
    ...
    override fun onCreate( savedInstanceState: Bundle? ) {
        ...
        et_name.setText( user!!.name )  // !! se agrego
    ...
    override fun onActivityResult(
        ...
        if( requestCode == RC_PICK_IMAGES
            ...
            if( images!!.isNotEmpty() ){   // !!   se agrego
                riv_profile.setImageURI(
                        Uri.parse( images.first().path )  // !!   se agrego
                )
            }
        }
